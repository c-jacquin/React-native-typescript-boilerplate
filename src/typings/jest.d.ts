...
declare namespace jest {
    ...
    function fn<T>(implementation?: () => void): Mock<T>
    ...
    interface MockInstance<T> {
        ...
        mockClear(): void
        mockReset(): void
        mockImplementation(fn: () => void): Mock<T>
        mockImplementationOnce(fn: () => void): Mock<T>
...
declare namespace jasmine {
    ...
    function createSpy(name: string, originalFn?: () => void): Spy
